...
front_server_url = ['http://172.16.182.144:5005/test']
model_server_url = ['http://172.16.182.144:5005/test']
...
def read_chapture():
    try:
        ...
        if data is not None:
            ...
            files = {}
            files['json'] = data2model
            for n in range(1):
                with open(f'image_{n}.jpg', 'rb') as image_file:
                    files[f'image_{n}'] = image_file
            print(6)
        # POST 요청 보내기
